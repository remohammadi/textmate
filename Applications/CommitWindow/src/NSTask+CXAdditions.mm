...
+ (NSTask*)taskWithArguments:(NSArray*)args input:(NSFileHandle**)outWriteHandle output:(NSFileHandle**)outReadHandle error:(NSFileHandle**)outErrorHandle
{
...
+ (int) executeTaskWithArguments:(NSArray*)args input:(id)inputDataOrString outputData:(NSData**)outputData errorString:(NSString**)errorString;
{
	...
	task = [NSTask taskWithArguments:args input:(inputDataOrString == nil) ? NULL : &inputFile output:(outputData == NULL) ? NULL : &outputFile error:(errorString == NULL) ? NULL : &errorFile];
...
+ (int) executeTaskWithArguments:(NSArray*)args input:(id)inputDataOrString outputString:(NSString**)outputString errorString:(NSString**)errorString;
{
	NSData* outputData;
	int terminationStatus;

	terminationStatus = [self executeTaskWithArguments:args input:inputDataOrString outputData:(outputString == NULL) ? NULL : &outputData errorString:errorString];
